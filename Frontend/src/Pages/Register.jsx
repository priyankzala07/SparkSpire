...
const Register = () => {
    ...
    return (
        <div className="max-w-md mx-auto mt-16 bg-slate-900 p-8 rounded-xl shadow-lg border border-slate-700">
            <div className="text-center mb-8">
                <h2 className="text-3xl font-extrabold text-white mb-2">Create an Account</h2>
                <p className="text-slate-400">Join SparkSpire today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                {!showOTP ? (
                    <>
                        <div>
                            ...
                            <input
                                type="text"
                                required
                                className="w-full px-4 py-3 rounded-lg border border-slate-600 focus:ring-2 focus:ring-slate-500 transition shadow-sm"
                                value={name}
                    ...
                    <div>
                        <p className="text-sm text-green-700 bg-emerald-950/30 p-3 mb-4 rounded border border-green-200">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-slate-950 text-white font-bold py-3 rounded-lg hover:bg-black focus:ring-4 focus:ring-gray-200 transition shadow-md mt-4"
                >
