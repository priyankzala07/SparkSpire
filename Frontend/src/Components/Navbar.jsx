...
const Navbar = () => {
  ...
  const navLink =
    "px-5 py-2 rounded-full text-slate-300 font-medium transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-600 hover:to-emerald-500 hover:text-white hover:scale-105 ";

  return (
    <nav className="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-sm rounded-lg outline-none border-b border-slate-700 ">
